...
HD_PWD='C:/Users/acer/EE_271_Cache_Memory/EE_271_Cache_Memory.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log cache_system.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cache_system.tcl
